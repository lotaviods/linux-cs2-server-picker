...
Run the executable with administrator privileges (required for firewall operations):

```bash
sudo ./CS2ServerPicker
```

The application will automatically start the daemon in the background and run the GUI as the regular user.
